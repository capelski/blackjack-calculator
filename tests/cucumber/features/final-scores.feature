Feature: Final scores logic
  ...
  Scenario: Sort final scores with blackjack first and bust last
    Given final score groups with labels "18,Blackjack,20,22+,17"
    When I sort final score groups
    Then the sorted final score labels should be "Blackjack,20,18,17,22+"
